...
export class Sidebar {
  ...
  private readonly allNavItems: NavItem[] = [
    ...
    { label: 'Utilisateurs', route: '/admin/users', icon: Users, roles: ['ADMINISTRATEUR'] },
    { label: 'Assistant IA', route: '/admin/chat-ia', icon: Bot, roles: ['ADMINISTRATEUR', 'TECHNICIEN', 'OBSERVATEUR', 'GESTIONNAIRE_STOCK'] },
